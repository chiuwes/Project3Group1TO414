...
combined_data <- as_data_frame(lapply(combined_data, function(x) {
...
data_train <- combined_data[1:337256, ]
data_test <- combined_data[337257:421570, ]
```
...
library(ggplot2)
library(jtools)
first_model <-lm(Weekly_Sales ~ month + year + Dept + IsHoliday + Type + Size + Temperature + Fuel_Price + CPI + Unemployment, data_train)
